...
public class SOCIALAdapter extends ArrayAdapter<SOCIAL> {
    ...
    public SOCIALAdapter(Context context, int layoutResourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final SOCIAL currentItem = getItem(position);
        ...
        checkBox.setText(currentItem.getUsername());
            ...
            public void onClick(View arg0) {
                if (checkBox.isChecked()) {
                    ...
                    if (mContext instanceof AzureDB) {
                        ...
                        activity.checkSOCIAL(currentItem);
                    }
                }
            }
        });
