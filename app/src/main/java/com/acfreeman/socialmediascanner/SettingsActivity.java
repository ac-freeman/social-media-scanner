...
public class SettingsActivity extends AppCompatPreferenceActivity implements CustomDialogFragment.NoticeDialogListener {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || MyProfileFragment.class.getName().equals(fragmentName)
...
//                    editor.commit(); // Very important to save the preference
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class MyProfileFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_myprofile);
