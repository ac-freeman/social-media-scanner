...
//
        ...
        for (int i = 0; i <= emails.size(); i++) {
            data[1 + phones.size() + 1+ i] = 2;
        }

        ListView listview = (ListView) findViewById(R.id.listview);
        listview.setAdapter(new RegistrationAdapter(this, data, phones, emails));
        Log.i("REGISTRATION", Arrays.toString(data));
...
//        submitButton.setBackgroundColor(getResources().getColor(R.color.white));
//        submitButton.setTextColor(getResources().getColor(R.color.secondary));
